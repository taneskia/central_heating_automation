...
(function () {
    ...
    ***************************************************************************** */
    ...
    var control = function (controlClass, ledId, label, labelPlacement, labelAlignment, shape, color, glow, sizeMultiplier) {
        ...
        var controlStyle = String.raw(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n    div.", ".control {\n      display: flex;\n      flex-direction: row;\n      flex-wrap: nowrap;\n\n      justify-content: ", ";\n      align-items: center;\n\n      height: 100%;\n      width: 100%;\n      position: relative;\n\n      overflow: hidden;\n    }"], ["\n    div.", ".control {\n      display: flex;\n      flex-direction: row;\n      flex-wrap: nowrap;\n\n      justify-content: ", ";\n      align-items: center;\n\n      height: 100%;\n      width: 100%;\n      position: relative;\n\n      overflow: hidden;\n    }"])), controlClass, hasName() ? 'space-between' : 'center');
        var labelStyle = String.raw(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n    div.", " > span.name {\n      text-align: ", ";\n      margin-left: 6px;\n      margin-right: 6px;\n      overflow-wrap: break-word;\n      overflow: hidden;\n      text-overflow: ellipsis;\n      flex-grow: 1;\n    }"], ["\n    div.", " > span.name {\n      text-align: ", ";\n      margin-left: 6px;\n      margin-right: 6px;\n      overflow-wrap: break-word;\n      overflow: hidden;\n      text-overflow: ellipsis;\n      flex-grow: 1;\n    }"])), controlClass, labelAlignment);
        var style = String.raw(templateObject_13 || (templateObject_13 = __makeTemplateObject(["<style>\n      ", "\n      ", "\n    </style>"], ["<style>\n      ", "\n      ", "\n    </style>"])), controlStyle, labelStyle);
        var allElements = String.raw(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n    <div class=\"", " control\">\n      ", "\n      ", "\n      ", "\n    </div>"], ["\n    <div class=\"", " control\">\n      ", "\n      ", "\n      ", "\n    </div>"])), controlClass, optionalName(labelPlacement !== 'right'), ledElement(controlClass, ledId, shape, color, glow, sizeMultiplier), optionalName(labelPlacement === 'right'));
